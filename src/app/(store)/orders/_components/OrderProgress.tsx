...
function OrderProgress({}: Props) {
  ...
  return (
    <section className="relative py-8 min-h-[120px] w-[80%] text-center">
      ...
      <span className="absolute left-0 bottom-0 text-center -translate-x-1/2">
        Ordered
      </span>
      <div className="absolute left-1/3 bottom-0  -translate-x-1/2">
        Shipped
      </div>
      <div className="absolute left-2/3 bottom-0  -translate-x-1/2">
        Out for delivery
      </div>
      <div className="absolute right-0 bottom-0 translate-x-1/2">Delivered</div>
